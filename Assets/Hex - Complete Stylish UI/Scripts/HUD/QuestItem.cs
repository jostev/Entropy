...
namespace Michsky.UI.Hex
{
    ...
    public class QuestItem : MonoBehaviour
    {
        ...
        {
            yield return new WaitForSeconds(HexUIInternalTools.GetAnimatorClipLength(questAnimator, "QuestItem_In"));
            questAnimator.enabled = false;
        }

        IEnumerator DisableItem()
        {
            yield return new WaitForSeconds(HexUIInternalTools.GetAnimatorClipLength(questAnimator, "QuestItem_Out"));
