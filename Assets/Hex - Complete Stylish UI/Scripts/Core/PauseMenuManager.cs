...
namespace Michsky.UI.Hex
{
    public class PauseMenuManager : MonoBehaviour
    {
        ...
        void Start()
        {
            if (panelManager != null) { disableAfter = HexUIInternalTools.GetAnimatorClipLength(panelManager.panels[panelManager.currentPanelIndex].panelObject, "MainPanel_OutBottom"); }
