...
namespace Michsky.UI.Hex
{
    ...
    public class LocalizedObjectEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            if (EditorGUIUtility.isProSkin) { customSkin = HexUIEditorHandler.GetDarkEditor(); }
            else { customSkin = HexUIEditorHandler.GetLightEditor(); }

            if (loTarget.localizationSettings == null
                && Resources.Load<UIManager>("Hex UI Manager") != null
                && Resources.Load<UIManager>("Hex UI Manager").localizationSettings != null)
            {
                loTarget.localizationSettings = Resources.Load<UIManager>("Hex UI Manager").localizationSettings;
            }
        ...
        {
            HexUIEditorHandler.DrawComponentHeader(customSkin, "TopHeader_Localization");
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    HexUIEditorHandler.DrawProperty(localizationSettings, customSkin, "Loc. Settings");
                    GUI.enabled = true;
                    ...
                    {
                        HexUIEditorHandler.DrawProperty(audioObj, customSkin, "Audio Source");
                    }

                    else if (loTarget.objectType == LocalizedObject.ObjectType.Image)
                    {
                        HexUIEditorHandler.DrawProperty(imageObj, customSkin, "Image Object");
                    }
                    ...
                    {
                        HexUIEditorHandler.DrawHeader(customSkin, "Header_Tables", 10);
                ...
                case 1:
                    ...
                    rebuildLayoutOnUpdate.boolValue = HexUIEditorHandler.DrawToggle(rebuildLayoutOnUpdate.boolValue, customSkin, "Rebuild Layout On Update", "Force to rebuild layout on item update to prevent visual glitches.");
                    break;
            }
