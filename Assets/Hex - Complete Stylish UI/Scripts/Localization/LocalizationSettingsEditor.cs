...
namespace Michsky.UI.Hex
{
    ...
    public class LocalizationSettingsEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Available Header_Languages
            HexUIEditorHandler.DrawHeader(customSkin, "Header_Languages", 14);
            GUILayout.Space(-3);
            ...
            for (int i = 0; i < lsTarget.languages.Count; i++)
            {
                ...
                lsTarget.languages[i].isExpanded = GUILayout.Toggle(lsTarget.languages[i].isExpanded, new GUIContent(""), customSkin.FindStyle("ToggleHelper"));
                GUILayout.EndHorizontal();
            ...
            // Available Header_Tables
            HexUIEditorHandler.DrawHeader(customSkin, "Header_Tables", 14);
            GUILayout.Space(-3);
            ...
            for (int i = 0; i < lsTarget.tables.Count; i++)
            {
                ...
                lsTarget.tables[i].isExpanded = GUILayout.Toggle(lsTarget.tables[i].isExpanded, new GUIContent(""), customSkin.FindStyle("ToggleHelper"));
                GUILayout.EndHorizontal();
            ...
            enableExperimental.boolValue = HexUIEditorHandler.DrawToggle(enableExperimental.boolValue, customSkin, "Enable Experimental Features");
            #endregion

            #region Support
            HexUIEditorHandler.DrawHeader(customSkin, "Header_Support", 14);
        ...
        void Docs() { Application.OpenURL("https://docs.michsky.com/docs/reach-ui/localization"); }
    }
}
#endif