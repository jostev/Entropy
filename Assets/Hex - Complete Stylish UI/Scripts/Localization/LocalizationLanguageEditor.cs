...
namespace Michsky.UI.Hex
{
    ...
    public class LocalizationLanguageEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Info Header
            HexUIEditorHandler.DrawHeader(customSkin, "Header_Content", 8);
            ...
            GUI.enabled = false;
            HexUIEditorHandler.DrawProperty(languageID, customSkin, "Language ID");
            HexUIEditorHandler.DrawProperty(languageName, customSkin, "Language Name");
            HexUIEditorHandler.DrawProperty(localizedName, customSkin, "Localized Name");
            GUI.enabled = true;
