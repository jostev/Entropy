...
namespace Michsky.UI.Hex
{
    ...
    public class UIManagerSplashScreen : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            if (UIManagerAsset == null) { UIManagerAsset = Resources.Load<UIManager>("Hex UI Manager"); }
            if (!UIManagerAsset.enableDynamicUpdate) { UpdatePAK(); this.enabled = false; }
        }
        ...
        void UpdatePAK()
        {
            ...
            if (UIManagerAsset.pakType == UIManager.PressAnyKeyTextType.Default && !UIManagerAsset.enableLocalization) { AnalyzePAKText(); }
            else if (UIManagerAsset.pakType == UIManager.PressAnyKeyTextType.Default && UIManagerAsset.enableLocalization) { AnalyzePAKLocalizationText(); }
        }
    }
}