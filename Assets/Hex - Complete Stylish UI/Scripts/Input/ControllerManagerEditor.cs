...
namespace Michsky.UI.Hex
{
    ...
    public class ControllerManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            HexUIEditorHandler.DrawProperty(presetManager, customSkin, "Preset Manager");
            HexUIEditorHandler.DrawProperty(firstSelected, customSkin, "First Selected", "UI element to be selected first in the home panel (e.g. Play button).");
            ...
            alwaysUpdate.boolValue = HexUIEditorHandler.DrawToggle(alwaysUpdate.boolValue, customSkin, "Always Update");
            affectCursor.boolValue = HexUIEditorHandler.DrawToggle(affectCursor.boolValue, customSkin, "Affect Cursor", "Changes the cursor state depending on the controller state.");
