...
namespace Michsky.UI.Hex
{
    ...
    public class ControllerManager : MonoBehaviour
    {
        ...
        public List<SpotButtonManager> spotButtons = new List<SpotButtonManager>();
        ...
        void CheckForEmptyObject()
        {
            ...
            else if (EventSystem.current.currentSelectedGameObject != null && EventSystem.current.currentSelectedGameObject.activeInHierarchy) { return; }
        ...
        public void SwitchToGamepad()
        {
            ...
            for (int i = 0; i < spotButtons.Count; i++) { if (spotButtons[i] != null && !spotButtons[i].useUINavigation) { spotButtons[i].AddUINavigation(); } }
        ...
        void CheckForGamepadType()
        {
            ...
            // Search for main and custom gamepads
        ...
        public void SwitchToKeyboard()
        {
            ...
            for (int i = 0; i < spotButtons.Count; i++) { if (spotButtons[i] != null && !spotButtons[i].useUINavigation) { spotButtons[i].DisableUINavigation(); } }
