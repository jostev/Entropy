...
namespace Michsky.UI.Hex
{
    ...
    public class SocialsWidgetEditor : Editor
    {
        ...
        {
            HexUIEditorHandler.DrawComponentHeader(customSkin, "TopHeader_SocialsWidget");
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    HexUIEditorHandler.DrawProperty(buttonPreset, customSkin, "Button Preset");
                    HexUIEditorHandler.DrawProperty(buttonParent, customSkin, "Button Parent");
                ...
                case 2:
                    ...
                    allowTransition.boolValue = HexUIEditorHandler.DrawToggle(allowTransition.boolValue, customSkin, "Allow Transition", "Pause or unpause the transition.");
                    ...
                    HexUIEditorHandler.DrawProperty(timer, customSkin, "Timer");
                    HexUIEditorHandler.DrawProperty(tintSpeed, customSkin, "Tint Speed");
                    HexUIEditorHandler.DrawProperty(tintCurve, customSkin, "Tint Curve");
