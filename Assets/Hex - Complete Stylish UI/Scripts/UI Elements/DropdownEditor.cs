...
namespace Michsky.UI.Hex
{
    ...
    public class DropdownEditor : Editor
    {
        ...
        {
            HexUIEditorHandler.DrawComponentHeader(customSkin, "TopHeader_Dropdown");
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    HexUIEditorHandler.DrawProperty(triggerObject, customSkin, "Trigger Object");
                    HexUIEditorHandler.DrawProperty(headerText, customSkin, "Header Text");
                    HexUIEditorHandler.DrawProperty(headerImage, customSkin, "Header Image");
                    HexUIEditorHandler.DrawProperty(itemPreset, customSkin, "Item Preset");
                    HexUIEditorHandler.DrawProperty(itemParent, customSkin, "Item Parent");
                    HexUIEditorHandler.DrawProperty(scrollbar, customSkin, "Scrollbar");
                    HexUIEditorHandler.DrawProperty(highlightCG, customSkin, "Highlight CG");
                    HexUIEditorHandler.DrawProperty(contentCG, customSkin, "Content CG");
                    HexUIEditorHandler.DrawProperty(listCG, customSkin, "List CG");
                    HexUIEditorHandler.DrawProperty(listRect, customSkin, "List Rect");
                    break;

                case 2:
                    HexUIEditorHandler.DrawHeader(customSkin, "Header_Customization", 6);
                    enableIcon.boolValue = HexUIEditorHandler.DrawToggle(enableIcon.boolValue, customSkin, "Enable Header Icon");
                    ...
                    enableScrollbar.boolValue = HexUIEditorHandler.DrawToggle(enableScrollbar.boolValue, customSkin, "Enable Scrollbar");
                    ...
                    startAtBottom.boolValue = HexUIEditorHandler.DrawToggle(startAtBottom.boolValue, customSkin, "Start At Bottom");
                    useGamepadInput.boolValue = HexUIEditorHandler.DrawToggle(useGamepadInput.boolValue, customSkin, "Use Gamepad Input");

                    HexUIEditorHandler.DrawPropertyCW(itemSpacing, customSkin, "Item Spacing", 90);
                    ...
                    HexUIEditorHandler.DrawHeader(customSkin, "Header_Animation", 10);
                    HexUIEditorHandler.DrawProperty(panelDirection, customSkin, "Panel Direction");
                    HexUIEditorHandler.DrawProperty(panelSize, customSkin, "Panel Size");
                    HexUIEditorHandler.DrawProperty(curveSpeed, customSkin, "Curve Speed");
                    HexUIEditorHandler.DrawProperty(animationCurve, customSkin, "Animation Curve");

                    HexUIEditorHandler.DrawHeader(customSkin, "Header_Settings", 10);
                    initOnEnable.boolValue = HexUIEditorHandler.DrawToggle(initOnEnable.boolValue, customSkin, "Initialize On Enable");
                    ...
                    enableTrigger.boolValue = HexUIEditorHandler.DrawToggle(enableTrigger.boolValue, customSkin, "Enable Trigger", "Clicking outside will close the dropdown.");
                    ...
                    setHighPriority.boolValue = HexUIEditorHandler.DrawToggle(setHighPriority.boolValue, customSkin, "Set High Priority");
                    ...
                    outOnPointerExit.boolValue = HexUIEditorHandler.DrawToggle(outOnPointerExit.boolValue, customSkin, "Out On Pointer Exit", "Close the dropdown on pointer exit.");
                    useSounds.boolValue = HexUIEditorHandler.DrawToggle(useSounds.boolValue, customSkin, "Use Sounds");
                 
                    GUILayout.BeginVertical(EditorStyles.helpBox);
                    GUILayout.Space(-3);
                    saveSelected.boolValue = HexUIEditorHandler.DrawTogglePlain(saveSelected.boolValue, customSkin, "Save Selected");                 
                    GUILayout.Space(3);

                    if (saveSelected.boolValue == true)
                    {
                        HexUIEditorHandler.DrawPropertyPlainCW(saveKey, customSkin, "Save Key:", 66);
