...
namespace Michsky.UI.Hex
{
    ...
    public class ProgressBarEditor : Editor
    {
        ...
        {
            HexUIEditorHandler.DrawComponentHeader(customSkin, "TopHeader_ProgressBar");
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    if (pbTarget.barImage != null) { HexUIEditorHandler.DrawPropertyCW(icon, customSkin, "Bar Icon", 99); }
                ...
                case 2:
                    ...
                    HexUIEditorHandler.DrawPropertyCW(decimals, customSkin, "Decimals", 80);
                    ...
                    HexUIEditorHandler.DrawPropertyCW(barDirection, customSkin, "Bar Direction", 80);
                    break;
            }
