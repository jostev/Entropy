...
namespace Michsky.UI.Hex
{
    ...
    public class TimerBarEditor : Editor
    {
        ...
        {
            HexUIEditorHandler.DrawComponentHeader(customSkin, "TopHeader_TimerBar");
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    if (tbTarget.barImage != null) { HexUIEditorHandler.DrawProperty(icon, customSkin, "Bar Icon"); }
                    ...
                    HexUIEditorHandler.DrawProperty(timerValue, customSkin, "Timer Value");
                    HexUIEditorHandler.DrawProperty(timeMultiplier, customSkin, "Time Multiplier");
                ...
                case 1:
                    ...
                    HexUIEditorHandler.DrawProperty(barImage, customSkin, "Bar Image");
                    HexUIEditorHandler.DrawProperty(iconObject, customSkin, "Icon Object");
                    HexUIEditorHandler.DrawProperty(altIconObject, customSkin, "Alt Icon Object");
                    HexUIEditorHandler.DrawProperty(textObject, customSkin, "Text Object");
                    HexUIEditorHandler.DrawProperty(altTextObject, customSkin, "Alt Text Object");
                    break;

                case 2:
                    HexUIEditorHandler.DrawHeader(customSkin, "Header_Settings", 6);

                    canPlay.boolValue = HexUIEditorHandler.DrawToggle(canPlay.boolValue, customSkin, "Can Play");
                    GUILayout.BeginVertical(EditorStyles.helpBox);
                    GUILayout.Space(-3);
                    addPrefix.boolValue = HexUIEditorHandler.DrawTogglePlain(addPrefix.boolValue, customSkin, "Add Prefix");
                    GUILayout.Space(3);

                    if (addPrefix.boolValue == true)
                        HexUIEditorHandler.DrawPropertyPlainCW(prefix, customSkin, "Prefix:", 40);

                    GUILayout.EndVertical();
                    GUILayout.BeginVertical(EditorStyles.helpBox);
                    GUILayout.Space(-3);
                    addSuffix.boolValue = HexUIEditorHandler.DrawTogglePlain(addSuffix.boolValue, customSkin, "Add Suffix");
                    GUILayout.Space(3);

                    if (addSuffix.boolValue == true)
                        HexUIEditorHandler.DrawPropertyPlainCW(suffix, customSkin, "Suffix:", 40);

                    GUILayout.EndVertical();

                    HexUIEditorHandler.DrawPropertyCW(decimals, customSkin, "Decimals", 84);
                    HexUIEditorHandler.DrawPropertyCW(barDirection, customSkin, "Bar Direction", 84);
                    HexUIEditorHandler.DrawPropertyCW(timeMode, customSkin, "Time Mode", 84);
                    break;
            }
