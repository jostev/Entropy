        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (buttonTarget.latestTabIndex)
            {
                case 0:
                    ...
                    if (useCustomContent.boolValue == false)
                    {
                        if (buttonTarget.normalImageObj != null || buttonTarget.highlightImageObj != null)
                        {
                            ...
                            {
                                HexUIEditorHandler.DrawPropertyCW(buttonIcon, customSkin, "Button Icon", 80);
                                HexUIEditorHandler.DrawPropertyCW(iconScale, customSkin, "Icon Scale", 80);
                                if (enableText.boolValue == true) { HexUIEditorHandler.DrawPropertyCW(spacing, customSkin, "Spacing", 80); }
                            }
                        ...
                        if (buttonTarget.normalTextObj != null || buttonTarget.highlightTextObj != null)
                        {
                            ...
                            enableText.boolValue = HexUIEditorHandler.DrawTogglePlain(enableText.boolValue, customSkin, "Enable Text");

                            GUILayout.Space(4);

                            if (enableText.boolValue == true)
                            {
                                HexUIEditorHandler.DrawPropertyCW(buttonText, customSkin, "Button Text", 80);
                                if (useCustomTextSize.boolValue == false) { HexUIEditorHandler.DrawPropertyCW(textSize, customSkin, "Text Size", 80); }
                            }
                    ...
                    autoFitContent.boolValue = HexUIEditorHandler.DrawTogglePlain(autoFitContent.boolValue, customSkin, "Auto-Fit Content", "Sets the width based on the button content.");
                ...
                case 1:
                    ...
                    HexUIEditorHandler.DrawProperty(tooltipObject, customSkin, "Tooltip Object");

                    if (enableText.boolValue == true)
                    {
                        HexUIEditorHandler.DrawProperty(normalTextObj, customSkin, "Normal Text");
                        HexUIEditorHandler.DrawProperty(highlightTextObj, customSkin, "Highlighted Text");
                        HexUIEditorHandler.DrawProperty(disabledTextObj, customSkin, "Disabled Text");
                    }

                    if (enableIcon.boolValue == true)
                    {
                        HexUIEditorHandler.DrawProperty(normalImageObj, customSkin, "Normal Icon");
                        HexUIEditorHandler.DrawProperty(highlightImageObj, customSkin, "Highlight Icon");
                        HexUIEditorHandler.DrawProperty(disabledImageObj, customSkin, "Disabled Icon");
                    }

                    HexUIEditorHandler.DrawProperty(disabledLayout, customSkin, "Disabled Layout");
                    HexUIEditorHandler.DrawProperty(normalLayout, customSkin, "Normal Layout");
                    HexUIEditorHandler.DrawProperty(highlightedLayout, customSkin, "Highlighted Layout");
                    HexUIEditorHandler.DrawProperty(mainLayout, customSkin, "Main Layout");

                    if (autoFitContent.boolValue == true)
                    {
                        HexUIEditorHandler.DrawProperty(mainFitter, customSkin, "Main Fitter");
                        HexUIEditorHandler.DrawProperty(targetFitter, customSkin, "Target Fitter");
                        HexUIEditorHandler.DrawProperty(targetRect, customSkin, "Target Rect");
                    }
                    break;
                ...
                case 2:
                    ...
                    useCustomTextSize.boolValue = HexUIEditorHandler.DrawToggle(useCustomTextSize.boolValue, customSkin, "Use Custom Text Size");
