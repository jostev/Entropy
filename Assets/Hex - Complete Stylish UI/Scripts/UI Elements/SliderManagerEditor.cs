...
namespace Michsky.UI.Hex
{
    ...
    public class SliderManagerEditor : Editor
    {
        ...
        {
            HexUIEditorHandler.DrawComponentHeader(customSkin, "TopHeader_Slider");
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    HexUIEditorHandler.DrawProperty(sliderObject, customSkin, "Slider Source");
                    if (showValue.boolValue == true) { HexUIEditorHandler.DrawProperty(valueText, customSkin, "Label Text"); }
                ...
                case 2:
                    ...
                    usePercent.boolValue = HexUIEditorHandler.DrawToggle(usePercent.boolValue, customSkin, "Use Percent");
                    showValue.boolValue = HexUIEditorHandler.DrawToggle(showValue.boolValue, customSkin, "Show Label");
                    showPopupValue.boolValue = HexUIEditorHandler.DrawToggle(showPopupValue.boolValue, customSkin, "Show Popup Label");
                    useRoundValue.boolValue = HexUIEditorHandler.DrawToggle(useRoundValue.boolValue, customSkin, "Use Round Value");
