...
namespace Michsky.UI.Hex
{
    ...
    public class NewsSliderEditor : Editor
    {
        ...
        {
            HexUIEditorHandler.DrawComponentHeader(customSkin, "TopHeader_NewsSlider");
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    HexUIEditorHandler.DrawProperty(timerPreset, customSkin, "Timer Preset");
                    HexUIEditorHandler.DrawProperty(timerParent, customSkin, "Timer Parent");
                    break;

                case 2:
                    HexUIEditorHandler.DrawHeader(customSkin, "Header_Settings", 6);
                    allowUpdate.boolValue = HexUIEditorHandler.DrawToggle(allowUpdate.boolValue, customSkin, "Allow Update", "Pause or unpause the slider.");
                    ...
                    HexUIEditorHandler.DrawProperty(sliderTimer, customSkin, "Slider Timer");
