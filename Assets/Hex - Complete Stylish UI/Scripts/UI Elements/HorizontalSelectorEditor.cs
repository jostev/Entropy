...
namespace Michsky.UI.Hex
{
    ...
    public class HorizontalSelectorEditor : Editor
    {
        ...
        {
            HexUIEditorHandler.DrawComponentHeader(customSkin, "TopHeader_HorizontalSelector");
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    HexUIEditorHandler.DrawProperty(selectorAnimator, customSkin, "Animator");
                    HexUIEditorHandler.DrawProperty(label, customSkin, "Label");
                    HexUIEditorHandler.DrawProperty(labelHelper, customSkin, "Label Helper");
                    HexUIEditorHandler.DrawProperty(labelIcon, customSkin, "Label Icon");
                    HexUIEditorHandler.DrawProperty(labelIconHelper, customSkin, "Label Icon Helper");
                    HexUIEditorHandler.DrawProperty(indicatorParent, customSkin, "Indicator Parent");
                    HexUIEditorHandler.DrawProperty(indicatorObject, customSkin, "Indicator Object");
                    HexUIEditorHandler.DrawProperty(contentLayout, customSkin, "Content Layout");
                    HexUIEditorHandler.DrawProperty(contentLayoutHelper, customSkin, "Content Layout Helper");
                    break;
                ...
                case 2:
                    ...
                    GUILayout.BeginVertical(EditorStyles.helpBox);
                    GUILayout.Space(-3);
                    enableIndicator.boolValue = HexUIEditorHandler.DrawTogglePlain(enableIndicator.boolValue, customSkin, "Enable Indicators");
                    GUILayout.Space(3);
                    GUILayout.BeginHorizontal();
                    ...
                    HexUIEditorHandler.DrawProperty(iconScale, customSkin, "Icon Scale");
                    HexUIEditorHandler.DrawProperty(contentSpacing, customSkin, "Content Spacing");
                    GUI.enabled = true;
                    hsTarget.UpdateContentLayout();

                    HexUIEditorHandler.DrawHeader(customSkin, "Header_Settings", 10);
                    invokeOnAwake.boolValue = HexUIEditorHandler.DrawToggle(invokeOnAwake.boolValue, customSkin, "Invoke On Awake", "Process events on awake.");
                    invertAnimation.boolValue = HexUIEditorHandler.DrawToggle(invertAnimation.boolValue, customSkin, "Invert Animation");
                    loopSelection.boolValue = HexUIEditorHandler.DrawToggle(loopSelection.boolValue, customSkin, "Loop Selection");
                    ...
                    {
                        HexUIEditorHandler.DrawPropertyCW(saveKey, customSkin, "Save Key:", 66);
