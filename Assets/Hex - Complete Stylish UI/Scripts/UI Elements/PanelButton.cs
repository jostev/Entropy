...
namespace Michsky.UI.Hex
{
    ...
    public class PanelButton : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler, ISelectHandler, IDeselectHandler, ISubmitHandler
    {
        ...
        [HideInInspector] public PanelButtonDimmer dimmer;
        ...
        {
            if (dimmer != null) { dimmer.DimButtons(this); }
        ...
        {
            if (dimmer != null) { dimmer.LitButtons(); }
            if (!isInteractable || isSelected) { return; }
        ...
        public void UpdateUI()
        {
            ...
            if (selectedImageObj != null && selectedIcon != null) { selectedImageObj.transform.parent.gameObject.SetActive(true); selectedImageObj.sprite = selectedIcon; }
            else if (selectedImageObj != null && buttonIcon != null) { selectedImageObj.transform.parent.gameObject.SetActive(true); selectedImageObj.sprite = buttonIcon; }
            else if (selectedImageObj != null && buttonIcon == null && selectedIcon == null) { selectedImageObj.transform.parent.gameObject.SetActive(false); }
        ...
        public void SetSelected(bool value)
        {
            ...
            if (dimmer != null) { dimmer.LitButtons(this); }
