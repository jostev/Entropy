...
namespace Michsky.UI.Hex
{
    ...
    public class NotificationManager : MonoBehaviour
    {
        ...
        {
            yield return new WaitForSeconds(HexUIInternalTools.GetAnimatorClipLength(itemAnimator, "Notification_In"));
            itemAnimator.enabled = false;
        }

        IEnumerator DisableItem()
        {
            yield return new WaitForSeconds(HexUIInternalTools.GetAnimatorClipLength(itemAnimator, "Notification_Out"));
