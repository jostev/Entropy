...
namespace Michsky.UI.Hex
{
    ...
    public class HorizontalSelector : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            cachedStateLength = HexUIInternalTools.GetAnimatorClipLength(selectorAnimator, "HorizontalSelector_Next");
        }
        ...
        public void InitializeSelector()
        {
            ...
            if (enableIndicator) { UpdateIndicators(); }
        ...
        public void PreviousItem()
        {
            ...
            if (!loopSelection)
            {
                if (index != 0)
                {
                    ...
                    if (useLocalization && !string.IsNullOrEmpty(items[index].localizationKey)) { label.text = localizedObject.GetKeyOutput(items[index].localizationKey); }
            ...
            else
            {
                ...
                // Play the animation
                if (invertAnimation) { selectorAnimator.Play("Next"); }
                else { selectorAnimator.Play("Prev"); }
            }
        ...
        public void NextItem()
        {
            ...
            if (!loopSelection)
            {
                if (index != items.Count - 1)
                {
                    ...
                    // Play the animation
                    if (invertAnimation) { selectorAnimator.Play("Prev"); }
