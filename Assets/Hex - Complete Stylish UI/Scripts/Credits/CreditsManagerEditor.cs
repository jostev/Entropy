...
namespace Michsky.UI.Hex
{
    ...
    public class CreditsManagerEditor : Editor
    {
        ...
        {
            HexUIEditorHandler.DrawComponentHeader(customSkin, "TopHeader_Credits");
            ...
            switch (latestTabIndex)
            {
                case 0:
                    ...
                    HexUIEditorHandler.DrawProperty(creditsPreset, customSkin, "Credits Preset");
                ...
                case 1:
                    ...
                    HexUIEditorHandler.DrawProperty(backgroundImage, customSkin, "BG Image");
                    HexUIEditorHandler.DrawProperty(creditsListParent, customSkin, "List Parent");
                    HexUIEditorHandler.DrawProperty(scrollHelper, customSkin, "Scroll Helper");
                    HexUIEditorHandler.DrawProperty(creditsSectionPreset, customSkin, "Section Preset");
                    HexUIEditorHandler.DrawProperty(creditsMentionPreset, customSkin, "Mention Preset");
                    break;

                case 2:
                    HexUIEditorHandler.DrawHeader(customSkin, "Header_Settings", 6);
                    closeAutomatically.boolValue = HexUIEditorHandler.DrawToggle(closeAutomatically.boolValue, customSkin, "Close Automatically");
                    HexUIEditorHandler.DrawProperty(fadingMultiplier, customSkin, "Fading Multiplier", "Set the animation fade multiplier.");
                    HexUIEditorHandler.DrawProperty(scrollDelay, customSkin, "Scroll Delay");
                    HexUIEditorHandler.DrawProperty(scrollSpeed, customSkin, "Scroll Speed");
                    HexUIEditorHandler.DrawProperty(boostValue, customSkin, "Boost Value");
