...
namespace Michsky.UI.Hex
{
    ...
    public class CreditsManager : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (scrollHelper.value <= 0.005f && !invokedEndEvents) { onCreditsEnd.Invoke(); invokedEndEvents = true; }
        ...
        void InitCredits()
        {
            ...
            {
                GameObject go = Instantiate(creditsSectionPreset, new Vector3(0, 0, 0), Quaternion.identity);
            ...
            {
                GameObject go = Instantiate(creditsMentionPreset, new Vector3(0, 0, 0), Quaternion.identity);
                go.transform.SetParent(creditsListParent.transform, false);
